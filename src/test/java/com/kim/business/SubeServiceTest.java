...
class SubeServiceTest {
    ...
    public void shouldListAllRechargePointsFromCache() throws IOException, InterruptedException {
        ...
        ReflectionTestUtils.setField(subeService, "cached", new ObjectMapper().readValue(result, RechargePointResponse.class));
    ...
    @Test
    public void shouldFailWhenServiceResponseStatusIsNot200() throws IOException, InterruptedException {
